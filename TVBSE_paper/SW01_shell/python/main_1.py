...
LastEditTime: 2021-04-20 22:17:47
'''
...
hoopping = list(map(lambda x: x / 1000, list(range(0, 2040, 40))))
rebar = list(map(lambda x: x / 1000,
                 [0, 20, 110, 200, 300, 400, 500, 600, 700, 800, 890, 980, 1000]))
