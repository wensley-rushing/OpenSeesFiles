...
ops.nDMaterial('PlaneStressUserMaterial', 1, 40, 7, 20.7e6,
               2.07e6, -4.14e6, -0.002, -0.006, 0.001, 0.08)
...
ops.section('LayeredShell', 1, 10, 4, 0.0125, 11, 0.0002403, 11, 0.0003676, 4, 0.024696,
            4, 0.024696, 4, 0.024696, 4, 0.024696, 11, 0.0003676, 11, 0.0002403, 4, 0.0125)

ops.section('LayeredShell', 2, 8, 4, 0.0125, 11, 0.0002403, 10, 0.0002356,
            4, 0.0495241, 4, 0.0495241, 10, 0.0002356, 11, 0.0002403, 4, 0.0125)
...
ops.element('Truss', 41, 1, 6, 223.53e-6, 7)
...
ops.recorder('Node', '-file', '53.txt', ' -time',
             '-node',  53, '-dof', 1, 'disp')
ops.recorder('Node', '-file', '1.txt', '-time ', '-node',
